...
$adim = @$_GET['adim'];
$gecici2=$_SESSION['kulanici_duzenle'];
$uyeler2 = mysql_query("SELECT * FROM personel WHERE kullanici_adi='$gecici2'"); 
$uyebul2 = mysql_fetch_array($uyeler2);
$kullanici_adi = $uyebul2['kullanici_adi'];
...
<div class="kullanici_duzenle ortak_div_ozellikleri">
<form action="kullanici_duzenle.php?adim=girisonay" method="post">
<table align="center" border="5">

<tr>
<td align="left" width="200"><h4>Kullanıcı Adı</h4></td>
<td align="left" width="150"><input name="kullanici_adi" type="text" value="<?php echo ''.$kullanici_adi.''; ?>"></td>
<td><h5><font color="red">*Boş Bırakılamaz</font></h5></td>
</tr>
<tr>
<td align="left" width="200"><h4>Adi Soyadi</h4></td>
<td align="left" width="150"><input name="ad_soyad" type="text" value="<?php echo ''.$ad_soyad.''; ?>"></td>
<td><h5><font color="red">*Bos Bırakılamaz</font></h5></td>
</tr>
<tr>
<td align="left" width="200"><h4>Sifre</h4></td>
<td align="left" width="150"><input name="sifre" type="text"></td>
<td><h5><font color="red">*Boş Bırakırsanız eski şifreniz geçerli olacaktır</font></h5></td>
<tr>
<td>&nbsp;  </td>
<td><input type="submit" class="buton" value="Kullanıcı Güncelle"></td>
<td>&nbsp;  </td>
</tr>
</table>
...
else
{
	...
	{
	if ($sifre=="")
		mysql_query("UPDATE personel set kullanici_adi='".$kullanici_adi."',ad_soyad='".$ad_soyad."' where kullanici_adi='".$gecici2."' ");
		else
		mysql_query("UPDATE personel set kullanici_adi='".$kullanici_adi."',ad_soyad='".$ad_soyad."',sifre='".$sifreli."' where kullanici_adi='".$gecici2."' ");
