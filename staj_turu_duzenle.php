...
$adim = @$_GET['adim'];
$gecici=$_SESSION['staj_turu_duzenle'];
$uyeler2 = mysql_query("SELECT * FROM staj_turu WHERE id='$gecici'"); 
...
<div class="staj_turu_duzenle ortak_div_ozellikleri">
<form action="staj_turu_duzenle.php?adim=girisonay" method="post">
...
<td align="left" width="150"><input name="en_az" type="text" value="<?php echo ''.$en_az.'';?>"></td>
<td><h5><font color="red">*Boş Bırakılamaz</font></h5></td>
</tr>
<td>&nbsp;  </td>
<td><input type="submit" class="buton" value="Staj Türü Güncelle"></td>
<td>&nbsp;  </td>
</tr>
</table>
...
{
		mysql_query("UPDATE staj_turu set ad='".$ad."',en_az='".$en_az."' where id='".$gecici."' ");
