...
<body><div class="ogrenci_sec ortak_div_ozellikleri">
<table align="right">

	<table border="1">
	<tr>
	
<form action="ogrenci_sec.php?adim4=girisonay4" method="post">
	...
	<form action="ogrenci_sec.php?adim2=<?php echo $ogrenci_no;	 ?>" method="post">
	<td align="center" width="50"><input type="button" name="sec" class="buton" value="seç" onclick="aktar('<?php echo $ogrenci_no;?>')"> </td>
	</form>
	</tr>
	<?php	
		}
