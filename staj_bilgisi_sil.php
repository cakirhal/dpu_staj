...
$bolum_adi=$uyeb['bolum_adi'];
	...
	<form action="staj_bilgisi_sil.php?adim=girisonay" method="post">
	<table border="1">
	<tr>
	<td align="center" width="250"><h4><font color="black">Bilgilerini Silmek istediğiniz öğrencinin numarasını giriniz.</font></h4></td>
...
<form action="staj_bilgisi_sil.php?adim2=girisonay2" method="post">
	<?php
...
?>
	...
	echo '<meta http-equiv="refresh" content="0;URL=staj_bilgisi_sil.php">';
